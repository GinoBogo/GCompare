...
pub struct AppConfig {
    ...
    pub button_default_fg: String,
    pub button_primary_bg: String,
    pub button_primary_fg: String,
    pub button_secondary_bg: String,
    pub button_secondary_fg: String,
    pub button_highlight_bg: String,
    pub button_highlight_fg: String,
...
impl ApplicationState {
    ...
    pub fn update_config_from_ui(
        ...
        AppConfig {
            ...
            // Preserve button color settings
            button_default_bg: current_config.button_default_bg.clone(),
            button_default_fg: current_config.button_default_fg.clone(),
            button_primary_bg: current_config.button_primary_bg.clone(),
            button_primary_fg: current_config.button_primary_fg.clone(),
            button_secondary_bg: current_config.button_secondary_bg.clone(),
            button_secondary_fg: current_config.button_secondary_fg.clone(),
            button_highlight_bg: current_config.button_highlight_bg.clone(),
            button_highlight_fg: current_config.button_highlight_fg.clone(),
